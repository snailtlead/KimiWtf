...
Installing from the repository URL installs the **latest release**; pin a version with `/plugins install https://github.com/snailtlead/KimiWtf/releases/tag/v0.1.0`.
...
При установке из URL репозитория ставится **последний релиз**; зафиксировать версию можно так: `/plugins install https://github.com/snailtlead/KimiWtf/releases/tag/v0.1.0`.
